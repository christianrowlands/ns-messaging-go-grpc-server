...
func (x *EnergyDetectionData) GetHeading() float32 {
	if x != nil {
		return x.Heading
	}
	return 0
...
func (x *EnergyDetectionData) GetPitch() float32 {
	if x != nil {
		return x.Pitch
	}
	return 0
...
func (x *EnergyDetectionData) GetRoll() float32 {
	if x != nil {
		return x.Roll
	}
	return 0
...
func (x *EnergyDetectionData) GetFieldOfView() float32 {
	if x != nil {
...
func (x *EnergyDetectionData) GetReceiverSensitivity() float32 {
	if x != nil {
...
var file_com_craxiom_messaging_energy_detection_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x98, 0x06, 0x0a, 0x13, 0x45, 0x6e, 0x65, 0x72, 0x67, 0x79,
